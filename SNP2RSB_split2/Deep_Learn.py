...
### 参数 
wk_dir = 'D:/desk/github/OE_Machine_learning/SNP2RSB_split2/'
x_file_train = 'D:/desk/github/OE_Machine_learning/SNP2RSB_split2/data/train/new.ped'  # 特征值
y_file_train = 'D:/desk/github/OE_Machine_learning/SNP2RSB_split2/data/train/overall_pheno.xls'  # 结果
x_file_test = 'D:/desk/github/OE_Machine_learning/SNP2RSB_split2/data/test/new.ped'  # 特征值
y_file_test = 'D:/desk/github/OE_Machine_learning/SNP2RSB_split2/data/test/overall_pheno.xls'  # 结果
##################  超参
Threshold = 40
num_epoch = 1500
lr = 0.001
